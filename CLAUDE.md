...
| `ALLURE_PUSH_TO_TESTOPS` | нет | `true` | Записывать результаты анализа (KB/LLM) в Allure TestOps как комментарии к тест-кейсам. `false` — отключить всю запись |
